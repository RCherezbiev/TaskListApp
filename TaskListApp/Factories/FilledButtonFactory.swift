...
//  TaskListApp
//
//  Created by Rustam Cherezbiev on 23.02.2024.
//
...
final class FilledButtonFactory: ButtonFactory {
    ...
    func createButton() -> UIButton {
        // Create an attributes container and set the font
        var attributes = AttributeContainer()
        attributes.font = UIFont.boldSystemFont(ofSize: 18)
        
        // Create filled button configuration and set the background color and title
